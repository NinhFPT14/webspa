...
Scheduler.plugin(function(e) {
    e._temp_matrix_scope = function() {
        function t(e, a) { if (a = a || [], e.children)
                for (var n = 0; n < e.children.length; n++) a.push(e.children[n].key), t(e.children[n], a); return a }

        function a(e, t) { var a = t.order[e]; return void 0 === a && (a = "$_" + e), a }

        function n(e, t) { if (t[e.key] = e, e.children)
                for (var a = 0; a < e.children.length; a++) n(e.children[a], t) }

        function i(e) { for (var t = {}, a = e.y_unit_original || e.y_unit, i = 0; i < a.length; i++) n(a[i], t); return t }
        ...
        function r(t, n) {
            ...
            var s = i(n),
                l = "tree" == n.render;
            l && (o.$tree = {});
            for (var c = n.y_property, _ = 0; _ < t.length; _++) { var h = t[_],
                    u = h[c];
                d = a(u, n); var g = e._get_date_index(n, h.start_date),
                    f = e._get_date_index(n, h.end_date);
                h.end_date.valueOf() == n._trace_x[f].valueOf() && (f -= 1), o[d] || (o[d] = []), r(o, d, g, f); var v = s[u]; if (l && v && v.$parent)
                    for (; v.$parent;) { var m = s[v.$parent];
                        r(o.$tree, m.key, g, f), v = m } }
            return o
        }

        function o() { var e = document.createElement("p");
            e.style.width = "100%", e.style.height = "200px"; var t = document.createElement("div");
            t.style.position = "absolute", t.style.top = "0px", t.style.left = "0px", t.style.visibility = "hidden", t.style.width = "200px", t.style.height = "150px", t.style.overflow = "hidden", t.appendChild(e), document.body.appendChild(t); var a = e.offsetWidth;
            t.style.overflow = "scroll"; var n = e.offsetWidth; return a == n && (n = t.clientWidth), document.body.removeChild(t), a - n }

        function _(t) {
            return e._helpers.formatDate(t)
        }

        function d(t, a) { var n = t.querySelector(".dhx_timeline_data_wrapper"); return a.scrollable || (n = e.$container.querySelector(".dhx_cal_data")), n }

        function s(e) { return e.querySelector(".dhx_timeline_label_wrapper") }

        function l() { return e.$container.querySelector(".dhx_cal_data .dhx_timeline_label_col") }
        ...
        function c(t, a, n, i) {
            ...
            if (h && (h.addEventListener ? "onwheel" in document ? h.addEventListener("wheel", r) : "onmousewheel" in document && h.addEventListener("mousewheel", r) : h.attachEvent("onmousewheel", r), !h.$eventsAttached)) {
                ...
                h.addEventListener("touchstart", function(e) { var t = e;
                    e.touches && (t = e.touches[0]), u = { pageX: t.pageX, pageY: t.pageY } }), h.addEventListener("touchmove", function(e) {
                    var t = e;
                    e.touches && (t = e.touches[0]);
                    var a = u.pageY - t.pageY;
                    u = { pageX: t.pageX, pageY: t.pageY }, a && (_.scrollTop += a), e && e.preventDefault && e.preventDefault()
                })
            }
            var g;
            if (_.onscroll = function(r) {
                    var s = d(t, a),
                        ...
                        f = e._timeline_smart_render.getViewPort(a.scrollHelper, 0, u, h),
                        v = l();
                    if (a.scrollable && (v.style.top = -h + "px"), !1 !== a.smart_rendering) {
                        if ((u !== a._x_scroll || a._is_ev_creating) && (a.second_scale ? e._timeline_smart_render.updateHeader(a, f, c.children[1]) : e._timeline_smart_render.updateHeader(a, f, c.children[0])), e.config.rtl) {
                        ...
                        (a._options_changed || h !== a._y_scroll || a._is_ev_creating) && e._timeline_smart_render.updateLabels(a, f, v), a._is_ev_creating = !1, e._timeline_smart_render.updateGridCols(a, f), e._timeline_smart_render.updateGridRows(a, f);
                        var y = !1;
                        "cell" != a.render && (window.requestAnimationFrame ? (y = !0, g && cancelAnimationFrame(g), g = requestAnimationFrame(function() {
                            a.name === e.getState().mode && (e._timeline_smart_render.updateEvents(a, f), g = 0,
                                a.callEvent("onScroll", [a.scrollHelper.getScrollValue(_), _.scrollTop]))
                        })) : e._timeline_smart_render.updateEvents(a, f));
                        var b = 0;
                        a._scales = {};
                        var x;
                        ...
                        for (var w = 0, k = x.length; w < k; w++) { var D = x[w].getAttribute("data-section-id"),
                                E = a.order[D];
                ...
                _.addEventListener("touchstart", function(e) { var t = e;
                        e.touches && (t = e.touches[0]), f = { pageX: t.pageX, pageY: t.pageY } }),
                    _.addEventListener("touchmove", function(t) { var n = t;
                        t.touches && (n = t.touches[0]); var i = l(),
                            r = f.pageX - n.pageX,
                            o = f.pageY - n.pageY; if (f = { pageX: n.pageX, pageY: n.pageY }, (r || o) && !e.getState().drag_id) { var d = Math.abs(r),
                                s = Math.abs(o),
                                c = Math.sqrt(r * r + o * o),
                                h = d / c,
                                u = s / c;
                            h < .42 ? r = 0 : u < .42 && (o = 0), a.scrollHelper.setScrollValue(_, a.scrollHelper.getScrollValue(_) + r), _.scrollTop += o, a.scrollable && o && (i.style.top = -_.scrollTop + "px") } return t && t.preventDefault && t.preventDefault(), !1 })
            }
        ...
        function h(e, t) {
            ...
            if (e.matches || e.msMatchesSelector || e.webkitMatchesSelector) { var a = e; if (!document.documentElement.contains(a)) return null;
                do { if ((a.matches || a.msMatchesSelector || a.webkitMatchesSelector).call(a, t)) return a;
                    a = a.parentElement || a.parentNode } while (null !== a && 1 === a.nodeType); return null }
            return window.console.error("Your browser is not supported"), null
        }

        function u(t, a) { var n = e.matrix[e._mode],
                i = {},
                r = {},
                o = a; for (i.x = t.touches ? t.touches[0].pageX : t.pageX, i.y = t.touches ? t.touches[0].pageY : t.pageY, r.left = o.offsetLeft + n.dx, r.top = o.offsetTop; o;) r.left += o.offsetLeft, r.top += o.offsetTop, o = o.offsetParent; return { x: i.x - r.left, y: i.y - r.top } }
        ...
        function f(t) {
            ...
            if (a) {
                ...
                var l = v(_, r, A ? A.x : 0, s.range_x);
                a.scrollable || (l = 0);
                var c = v(d, o, A ? A.y : 0, s.range_y);
                !c && !l || A || (A = { x: _, y: d }, l = 0,
                    c = 0), l *= s.speed_x, c *= s.speed_y, l && c && (Math.abs(l / 5) > Math.abs(c) ? c = 0 : Math.abs(c / 5) > Math.abs(l) && (l = 0)), l || c ? (A.started = !0, m(l, c)) : clearInterval(M)
            }
        }

        function v(e, t, a, n) { return e < n && (!A || A.started || e < a) ? -1 : t - e < n && (!A || A.started || e > a) ? 1 : 0 }

        function m(t, a) { var n = e._schedulerOuter;
        ...
        var p = function() {
            return function() {
                ...
                function t() { var t = _.minMax,
                        a = e(); return document.body.appendChild(a), a.scrollLeft > 0 ? t = _.minMax : (a.scrollLeft = -50, t = -50 === a.scrollLeft ? _.nMaxMin : _.maxMin), document.body.removeChild(a), t }

                function a(e, t) { var a = r(); return a === _.nMaxMin ? e ? -e : 0 : a === _.minMax ? t - e : e }

                function n(e) { var t = getComputedStyle(e).direction; if (t && "ltr" !== t) { var n = e.scrollWidth - e.offsetWidth; return a(e.scrollLeft, n) } return e.scrollLeft }

                function i(e, t) { var n = getComputedStyle(e).direction; if (n && "ltr" !== n) { var i = e.scrollWidth - e.offsetWidth,
                            r = a(t, i);
                        e.scrollLeft = r } else e.scrollLeft = t }

                function r() { return o || (o = t()), o }
                var o, _ = { minMax: "[0;max]", maxMin: "[max;0]", nMaxMin: "[-max;0]" };
                return { modes: _, getMode: r, normalizeValue: a, getScrollValue: n, setScrollValue: i }
            }
        }();
        e.matrix = {},
            e._merge = function(e, t) { for (var a in t) void 0 === e[a] && (e[a] = t[a]) }, e.createTimelineView = function(a) {
                function n(a, n, i) { var r = e._timeline_smart_render.getPreparedEvents(i),
                        o = i.order[a],
                        _ = i.y_unit[o]; if (!_) return []; var d = [a];
                    n && t(_, d); for (var s = [], l = 0; l < d.length; l++) { var o = i.order[d[l]]; if (void 0 !== o && r[o]) s = s.concat(r[o]);
                        else if (r.undefined)
                            for (var c = 0; c < r.undefined.length; c++) { var h = r.undefined[c];
                                h[i.y_property] == d[l] && s.push(h) } } return s }
                ...
                function r(t, a, n) { for (var i = e.date[n.name + "_start"](new Date(t)), r = 0, o = i, _ = n.x_step, d = n.x_unit; o < a;) r++, o = e.date.add(o, _, d); return r }
                ...
                e.render_data = function(t, n) {
                    ...
                    }, e.matrix[a.name] = a, e.templates[a.name + "_cell_value"] = function(e) { return e ? e.length : "" }, e.templates[a.name + "_cell_class"] = function(e) { return "" }, e.templates[a.name + "_scalex_class"] = function(e) { return "" }, e.templates[a.name + "_second_scalex_class"] = function(e) { return "" },
                    ...
                    e.templates[a.name + "_second_scale_date"] = e.date.date_to_str(a.second_scale && a.second_scale.x_date ? a.second_scale.x_date : e.config.hour_date), e.date["add_" + a.name + "_private"] = function(t, n) { var i = n,
                            r = a.x_unit; if ("minute" == a.x_unit || "hour" == a.x_unit) { var o = i; "hour" == a.x_unit && (o *= 60), o % 1440 || (i = o / 1440, r = "day") } return e.date.add(t, i, r) }, e.date["add_" + a.name] = function(t, n, i) {
                        ...
                        if (t) {
                            ...
                            var i;
                            if (i = "number" == typeof a ? a : this.posFromDate(a), e.config.rtl) { var r = +e.$container.querySelector(".dhx_timeline_label_wrapper").style.height.replace("px", ""),
                    ...
                    }, a), a.getScrollPosition = e.bind(function() { return { left: this._x_scroll || 0, top: this._y_scroll || 0 } }, a), a.posFromDate = e.bind(function(t) { return e._timeline_getX({ start_date: t }, !1, this) - 1 }, a), a.posFromSection = e.bind(function(e) {
                        var t = this.order[e];
                        if (void 0 === t) return -1;
                        var a = 0;
                        for (var n in this.order) this.order[n] < t && (a += this._section_height[n]);
                        return a
                    }, a), a.selectEvents = e.bind(function(e) { var t = e.section,
                            a = e.date,
                            r = e.selectNested; return a ? i(t, a, r, this) : t ? n(t, r, this) : void 0 }, a), a.setRange = e.bind(function(t, a) { var n = e.date[this.name + "_start"](new Date(t)),
                            i = r(t, a, this);
                        this.x_size = i, e.setCurrentView(n, this.name) }, a), e.callEvent("onOptionsLoad", [a]), e[a.name + "_view"] = function(t) { t ? e._set_timeline_dates(a) : e._renderMatrix.apply(a, arguments) };
                var d = new Date;
                ...
                e["mouse_" + a.name] = function(t) {
                    ...
                    if (t.x = 0, t.force_redraw = !0, t.custom = !0, "move" == this._drag_mode && this._drag_id && this._drag_event) {
                        ...
                        if (t._ignores = this._ignores_detected || a._start_correction || a._end_correction, void 0 === d._move_delta && (d._move_delta = (n.start_date - _) / 6e4,
                                this.config.preserve_length && t._ignores && (d._move_delta = this._get_real_event_length(n.start_date, _, a), d._event_length = this._get_real_event_length(n.start_date, n.end_date, a))), this.config.preserve_length && t._ignores) { var s = (d._event_length, this._get_fictional_event_length(_, d._move_delta, a, !0));
                            _ = new Date(_ - s) } else _ = e.date.add(_, d._move_delta, "minute")
                    }
                ...
                if ("cell" == t.render) a = e._timeline_trace_events.call(t);
                    ...
                    for (var n = e.get_visible_events(), i = t.order, r = 0; r < n.length; r++) { var o = n[r],
                            _ = o[t.y_property],
                            d = t.order[_];
                        t.y_unit[d]; if (t.show_unassigned && !_) { for (var s in i)
                                if (i.hasOwnProperty(s)) { d = i[s], a[d] || (a[d] = []); var l = e._lame_copy({}, o);
                                    l[t.y_property] = s, a[d].push(l); break } } else a[d] || (a[d] = []), a[d].push(o) }
                    a.$matrix = e._timeline_trace_events.call(t)
                }
                return a
            }, e._populate_timeline_rendered = function(t) { e._rendered = []; for (var a = t.querySelectorAll("div[event_id]"), n = 0; n < a.length; n++) e._rendered.push(a[n]) }, e._get_timeline_event_height = function(e, t) { var a = e[t.y_property],
                    n = t.event_dy; return "full" == t.event_dy && (n = t.section_autoheight ? t._section_height[a] - 6 : t.dy - 3), t.resize_events && (n = Math.max(Math.floor(n / (e._count || 1)), t.event_min_dy)), n }, e._get_timeline_event_y = function(t, a) {
                var n = t || 0,
                    i = 2 + n * a + (n ? 2 * n : 0);
                ...
                var h = t.color ? "background:" + t.color + ";" : "",
                    ...
                    f = "<div " + e._waiAria.eventBarAttrString(t) + " event_id='" + t.id + "' class='" + c + "' style='" + h + u + "position:absolute; top:" + s + "px; height: " + d + "px; " + (e.config.rtl ? "right:" : "left:") + r + "px; width:" + Math.max(0, o - r) + "px;" + (t._text_style || "") + "'>";
                if (e.config.drag_resize && !e.config.readonly) {
                    var v = "dhx_event_resize",
                        m = d + 1,
                        p = "<div class='" + v + " " + v + "_start' style='height: " + m + "px;'></div>",
                        y = "<div class='" + v + " " + v + "_end' style='height: " + m + "px;'></div>";
                    f += (t._no_resize_start ? "" : p) + (t._no_resize_end ? "" : y)
                }
                if (f += g + "</div>", !a) return f;
                var b = document.createElement("div");
                b.innerHTML = f;
                var x = this._scales[n];
                x && (e._rendered.push(b.firstChild), x.appendChild(b.firstChild))
            };
        var y = function(e) { return String(e).replace(/'/g, "&apos;").replace(/"/g, "&quot;") },
            b = function(e) {
                return String(e).replace(/'/g, "\\'").replace(/"/g, '\\"')
            };
        e._timeline_trace_events = function() { return r(e.get_visible_events(), this) }, e._timeline_getX = function(t, a, n) {
                var i = 0,
                    r = n._step,
                    o = n.round_position,
                    _ = 0,
                ...
                if (e._ignores_detected)
                    for (var a, n, i, r, o = 0; o < t.length; o++) { for (r = t[o], i = !1, a = e._get_date_index(this, r.start_date), n = e._get_date_index(this, r.end_date); a < n;) { if (!e._ignores[a]) { i = !0; break }
                            a++ }
                ...
                if (t && "cell" != this.render) {
                    ...
                    for (var a = [], n = t.length, i = -1, r = null, o = 0; o < n; o++) {
                        ...
                        for (this.round_position ? e._timeline_get_rounded_date.apply(this, [_.end_date, !0]) : _.end_date; a.length;) { if (!(a[a.length - 1].end_date.valueOf() <= d.valueOf())) break;
                            a.splice(a.length - 1, 1) }
                        for (var s = !1, l = 0; l < a.length; l++) {
                            var c = a[l];
                            if (c.end_date.valueOf() <= d.valueOf()) { s = !0, _._sorder = c._sorder, a.splice(l, 1), _._inner = !0; break }
                        }
                        if (a.length && (a[a.length - 1]._inner = !0), !s)
                            if (a.length)
                                if (a.length <= a[a.length - 1]._sorder) { if (a[a.length - 1]._sorder)
                                        for (var h = 0; h < a.length; h++) { for (var u = !1, g = 0; g < a.length; g++)
                                                if (a[g]._sorder == h) { u = !0; break }
                                            if (!u) { _._sorder = h; break } } else _._sorder = 0;
                                    _._inner = !0 } else {
                                    for (var f = a[0]._sorder, v = 1; v < a.length; v++) a[v]._sorder > f && (f = a[v]._sorder);
                                    _._sorder = f + 1, i < _._sorder && (i = _._sorder, r = _), _._inner = !1
                                }
                        else _._sorder = 0;
                        a.push(_), a.length > (a.max_count || 0) ? (a.max_count = a.length, _._count = a.length) : _._count = _._count ? _._count : 1
                    }
                    for (var m = 0; m < t.length; m++) t[m]._count = a.max_count, e._register_copy && e._register_copy(t[m]);
                    (r || t[0]) && e.render_timeline_event.call(this, r || t[0], !1)
                }
            }, e._timeline_get_events_html = function(t) { var a = ""; if (t && "cell" != this.render)
                    for (var n = 0; n < t.length; n++) a += e.render_timeline_event.call(this, t[n], !1); return a }, e._timeline_update_events_html = function(t) {
                var a = "";
                if (t && "cell" != this.render) { var n = e.getView(),
                        i = {},
                        r = function(e, t) { return e + "_" + t };
                    t.forEach(function(e) { i[r(e.id, e[n.y_property])] = !0 }), e._rendered.forEach(function(e) { if (e.parentNode) { var t = e.parentNode.getAttribute("data-section-id");
                            i[r(e.getAttribute("event_id"), t)] && e.parentNode.removeChild(e) } }); for (var o = 0; o < t.length; o++) a += e.render_timeline_event.call(this, t[o], !1) }
                return a
                ...
                if (e._merge(n, { height: t.dy }), t.section_autoheight) { var i = t.scrollable ? t._sch_height - e.xy.scroll_width : t._sch_height;
            ...
            }, e._timeline_save_scroll_pos = function(e, t, a, n) { e._y_scroll = t || 0, e._x_scroll = a || 0 }, e._timeline_get_html_for_cell_data_row = function(e, t, a, n, i) {
                var r = "";
            ...
            }, e._timeline_get_html_for_cell_ignores = function(e) { return '<div class="dhx_matrix_cell dhx_timeline_data_cell" style="' + e.style_height + e.style_line_height + ';display:none"></div>' }, e._timeline_get_html_for_cell = function(t, a, n, i, r, o) {
                var d = n._trace_x[t],
                    s = n.y_unit[a],
                    l = e._cols[t],
                    c = _(d),
            ...
            }, e._timeline_get_html_for_bar_data_row = function(e, t) { var a = e.table_className; return t.template && (a += " " + (t.template(t.section, t.view) || "")), "<div class='dhx_timeline_data_row " + a + "' style='" + e.summ_width + " " + e.style_height + "' >" }, e._timeline_get_html_for_bar_ignores = function() { return "" },
            e._timeline_get_html_for_bar = function(t, a, n, i, r, o) {
                ...
                var p, b = !!m;
                p = this.scrollable ? !1 !== this.smart_rendering && !!b : !!this.smart_rendering && b;
                ...
                for (var k = 0; k < this.y_unit.length; k++) {
                    var D = x[k],
                        E = this.y_unit[k],
                        S = "<div class='dhx_timeline_label_row " + D.tr_className + "' style='top:" + v + "px;" + D.style_height + D.style_line_height + "'data-row-index='" + k + "' data-row-id='" + y(E.key) + "'><div class='" + D.td_className + "' style='" + D.style_width + " height:" + D.height + "px;' " + e._waiAria.label(D.td_content) + ">" + D.td_content + "</div></div>";
                    if (p && this._label_rows.push({
                            div: S,
                            top: v,
                            section: E
                        }), p && (e._timeline_smart_render.isInYViewPort({ top: v, bottom: v + D.height }, m) || (f = !0)), v += D.height, f) f = !1;
                    else {
                        r += S, p && e._timeline_smart_render._rendered_labels_cache.push(k);
                        var N = e.templates[this.name + "_row_class"],
                            M = { view: this, section: E, template: N },
                            A = 0;
                        if ("cell" == this.render) {
                            o += e._timeline_get_html_for_cell_data_row(k, D, v - D.height, E.key, M);
                            for (var C = 0; C < e._cols.length; C++) e._ignores[C] && !p ? o += e._timeline_get_html_for_cell_ignores(D) : p && b ? e._timeline_smart_render.isInXViewPort({
                                left: A,
                                right: A + e._cols[C]
                            }, m) && (o += e._timeline_get_html_for_cell(C, k, this, _[k][C], D, A)) : o += e._timeline_get_html_for_cell(C, k, this, _[k][C], D, A), A += e._cols[C];
                            o += "</div>"
                        } else {
                            o += e._timeline_get_html_for_bar_matrix_line(k, D, v - D.height, E.key);
                            var O = _[k];
                            p && b && (O = e._timeline_smart_render.getVisibleEventsForRow(this, m, _, k));
                            o += e._timeline_get_events_html.call(this, O), o += e._timeline_get_html_for_bar_data_row(D, M);
                            for (var C = 0; C < e._cols.length; C++) e._ignores[C] ? o += e._timeline_get_html_for_bar_ignores() : p && b ? e._timeline_smart_render.isInXViewPort({ left: A, right: A + e._cols[C] }, m) && (o += e._timeline_get_html_for_bar(C, k, this, _[k], A)) : o += e._timeline_get_html_for_bar(C, k, this, _[k], A), A += e._cols[C];
                            o += "</div></div>"
                        }
                    }
                    D.sectionKey = E.key, g.push(D)
                }
                if (i += r + "</div></div>", i += o + "</div></div>", i += "</div>", this._matrix = _, t.innerHTML = i, p) { e.$container.querySelector(".dhx_timeline_data_col").style.height = v + "px" }
                e._populate_timeline_rendered(t), this._scales = {};
                for (var s = 0, T = g.length; s < T; s++) { u.push(g[s].height); var L = g[s].sectionKey;
            ...
            }, e._timeline_finalize_section_add = function(t, a, n) { var i = t._scales[a] = n.querySelector(".dhx_timeline_data_col [data-section-id='" + b(a) + "']");
                i && e.callEvent("onScaleAdd", [i, a]) },
            e.attachEvent("onBeforeViewChange", function(t, a, n, i) { if (e.matrix[n]) { var r = e.matrix[n]; if (r.scrollable) { if ("tree" == r.render && t === n && a === i) return !0;
                        r._x_scroll = r._y_scroll = 0, e.$container.querySelector(".dhx_timeline_scrollable_data") && e._timeline_set_scroll_pos(e._els.dhx_cal_data[0], r) } } return !0 }), e._timeline_x_dates = function(t) {
                var a = e._min_date,
                    n = e._max_date;
                ...
                if (this.scrollable && this.column_width > 0) { var d = this.column_width * r.displayed;
                ...
                if (t.innerHTML = "<div></div>", this.second_scale) {
                    for (var g = this.second_scale.x_unit, f = [this._trace_x[0]], v = [], m = [this.dx, this.dx], p = 0, y = 0; y < this._trace_x.length; y++) { var b = this._trace_x[y];
                        e._timeline_is_new_interval(g, b, f[p]) && (++p, f[p] = b, m[p + 1] = m[p]); var x = p + 1;
                        v[p] = e._cols[y] + (v[p] || 0), m[x] += e._cols[y] }
                    t.innerHTML = "<div></div><div></div>";
                    var w = t.firstChild;
                    w.style.height = n + "px";
                    var k = t.lastChild;
                    k.style.position = "relative", k.className = "dhx_bottom_scale_container";
                    for (var D = 0; D < f.length; D++) { var E = f[D],
                            S = e.templates[this.name + "_second_scalex_class"](E),
                            N = document.createElement("div");
                        N.className = "dhx_scale_bar dhx_second_scale_bar" + (S ? " " + S : ""), e.set_xy(N, v[D] - 1, n - 3, m[D], 0), N.innerHTML = e.templates[this.name + "_second_scale_date"](E), w.appendChild(N) }
                }
                e.xy.scale_height = n, t = t.lastChild,
                    this._h_cols = {};
                for (var M = 0; M < this._trace_x.length; M++)
                    if (!e._ignores[M]) { l = this._trace_x[M], e._render_x_header(M, s[M], l, t); var A = e.templates[this.name + "_scalex_class"](l);
                        A && (t.lastChild.className += " " + A), t.lastChild.setAttribute("data-col-id", M), t.lastChild.setAttribute("data-col-date", _(l)); var C = t.lastChild.cloneNode(!0);
                ...
                }, t.ondblclick = function(t) { var a = e._timeline_locate_hcell(t);
            ...
            e._timeline_set_full_view = function(t) {
                ...
                if ("cell" == t.render) {
                    ...
                    e._tooltip.style.display = "", e._tooltip.style.top = "0px", e.config.rtl && n.left - e._tooltip.offsetWidth >= 0 || document.body.offsetWidth - a.src.offsetWidth - n.left - e._tooltip.offsetWidth < 0 ? e._tooltip.style.left = n.left - e._tooltip.offsetWidth + "px" : e._tooltip.style.left = n.left + a.src.offsetWidth + "px", e._tooltip.date = i, e._tooltip.innerHTML = _,
                        document.body.offsetHeight - n.top - e._tooltip.offsetHeight < 0 ? e._tooltip.style.top = n.top - e._tooltip.offsetHeight + a.src.offsetHeight + "px" : e._tooltip.style.top = n.top + "px"
                            ...
                            t = t || event;
                        t.target || t.srcElement; if (n) return e._timeline_showToolTip(a, n, e.$domHelpers.getOffset(n.src)) }
                    e._timeline_hideToolTip() } }, e._init_matrix_tooltip = function() {
            ...
            }, e._timeline_html_index = function(t) { for (var a = t.parentNode.childNodes, n = -1, i = 0; i < a.length; i++)
                    if (a[i] == t) { n = i; break }
                var r = n; if (e._ignores_detected)
                    for (var o in e._ignores) e._ignores[o] && 1 * o <= r && r++; return r }, e._timeline_locate_hcell = function(t) {
                t = t || event;
                ...
                if (i.scrollable && "cell" === i.render) {
                    ...
                    if (!l) return;
                    var c = l.offsetLeft;
                    if (c > 0) { for (var u = e._timeline_drag_date(i, c), g = 0; g < i._trace_x.length - 1 && !(+u < i._trace_x[g + 1]); g++);
                        s = g }
                }
                n.src = i._scales[r.section] ? i._scales[r.section].querySelectorAll(".dhx_matrix_cell")[d - s] : null;
                var f = !1,
                    v = h(a, ".dhx_matrix_scell");
                return v && (a = v, f = !0), f ? (n.x = -1, n.src = a, n.scale = !0) : n.x = d, n
            };
        ...
        e.dblclick_dhx_marked_timespan = function(t) { return e.matrix[e._mode] ? e.dblclick_dhx_matrix_cell(t) : w.apply(this, arguments) }, e.dblclick_dhx_matrix_scell = function(t) { return e.dblclick_dhx_matrix_cell(t) }, e._isRender = function(t) {
        ...
        }), e.attachEvent("onBeforeDrag", function(t, a, n) { return !e._isRender("cell") }), e.attachEvent("onEventChanged", function(e, t) { t._timed = this.isOneDayEvent(t) }), e.attachEvent("onBeforeEventChanged", function(e, t, a, n) { return e && (e._move_delta = void 0), n && (n._move_delta = void 0), !0 }), e._is_column_visible = function(t) { var a = e.matrix[e._mode],
                n = e._get_date_index(a, t); return !e._ignores[n] };
        ...
        e._render_marked_timespan = function(t, a, n, i, r) {
            ...
            if (e.matrix && e.matrix[e._mode]) {
                ...
                if (n) s = [a], d = [n];
                else { var c = o.order; if (l) c.hasOwnProperty(l) && (d.push(l), s.push(o._scales[l]));
                    else if (o._scales)
                ...
                var g = [];
                if (t.days > 6) { var f = new Date(t.days);
                    e.date.date_part(new Date(i)) <= +f && +r >= +f && g.push(f) } else g.push.apply(g, e._get_dates_by_index(t.days));
                for (var v = t.zones, m = e._get_css_classes_by_config(t), p = 0; p < d.length; p++) {
                    a = s[p], n = d[p];
                    for (var u = 0; u < g.length; u++)
                        for (var y = g[u], b = 0; b < v.length; b += 2) {
                            var x = v[b],
                                w = v[b + 1],
        ...
        e._append_mark_now = function(t, a) {
            if (e.matrix && e.matrix[e._mode]) {
                var n = e._currentDate(),
                    ...
                    r = { days: +e.date.date_part(n), zones: [i, i + 1], css: "dhx_matrix_now_time", type: "dhx_now_time" };
                return e._render_marked_timespan(r)
            }
            return D.apply(e, [t, a])
        };
        var E = e._mark_timespans;
        e._mark_timespans = function() { if (e.matrix && e.matrix[e.getState().mode]) { for (var t = [], a = e.matrix[e.getState().mode], n = a.y_unit, i = 0; i < n.length; i++) { var r = n[i].key,
                        o = a._scales[r],
                        _ = e._on_scale_add_marker(o, r);
                    t.push.apply(t, _) } return t } return E.apply(this, arguments) };
        ...
        e._on_scale_add_marker = function(t, a) {
                ...
                if (i && e.matrix && e.matrix[e._mode])
                    for (var r = e._mode, o = e._min_date, _ = e._max_date, d = i.global, s = e.date.date_part(new Date(o)); s < _; s = e.date.add(s, 1, "day")) {
                        var l = +s,
                            ...
                            h = [],
                            u = d[l] || d[c];
                        if (h.push.apply(h, e._get_configs_to_render(u)), i[r] && i[r][a]) { var g = [],
                                f = e._get_types_to_render(i[r][a][c], i[r][a][l]);
                            g.push.apply(g, e._get_configs_to_render(f)), g.length && (h = g) }
            ...
            e.y_unit[a] || (a = e.y_unit.length - 1), this._drag_event && !this._drag_event._orig_section && (this._drag_event._orig_section = e.y_unit[a].key), t.fields = {},
                ...
                a[t.y_property] = n.section } }, e._get_date_index = function(e, t) {
            for (var a = e._trace_x, n = 0, i = a.length - 1, r = t.valueOf(); i - n > 3;) { var o = n + Math.floor((i - n) / 2);
            ...
            for (d; d <= this._cols.length - 1; d++)
                if (o = this._cols[d], (_ += o) > i.x) { r = (i.x - (_ - o)) / o, r = r < 0 ? 0 : r; break }
            if (n.round_position) { var s = 1,
            ...
            for (var t in e.matrix) {
                ...
                e.callEvent("onOptionsLoadFinal", []), e._date && a.name == e._mode && (a._options_changed = !0, e.setCurrentView(e._date, e._mode), setTimeout(function() { a._options_changed = !1 }))
            }
        }), e.attachEvent("onEventIdChange", function() { var t = e.getView();
            t && e.matrix[t.name] && e._timeline_smart_render && (e._timeline_smart_render.clearPreparedEventsCache(), e._timeline_smart_render.getPreparedEvents(t)) }), e.attachEvent("onBeforeDrag", function(t, a, n) {
            if ("resize" == a) { var i = n.target || n.srcElement;
        ...
        var N = 10,
            M = null,
            A = null,
            C = e.attachEvent("onSchedulerReady", function() { e.matrix && (e.event(document.body, "mousemove", g), e.detachEvent(C)) });
        e._timeline_smart_render = {
            ...
            _cols_to_delete: [],
            _cols_to_add: [],
            getViewPort: function(t, a, n, i) { var r = e.$container.querySelector(".dhx_cal_data"),
                    o = r.getBoundingClientRect(),
                    _ = e.$container.querySelector(".dhx_timeline_scrollable_data");
                _ && void 0 === n && (n = t.getScrollValue(_)), void 0 === i && (i = _ ? _.scrollTop : r.scrollTop); var d = {}; for (var s in o) d[s] = o[s]; return d.scrollLeft = n || 0, d.scrollTop = i || 0, a && (o.height = a), d },
            isInXViewPort: function(e, t) { var a = t.scrollLeft,
                    n = t.width + t.scrollLeft; return e.left < n + 100 && e.right > a - 100 },
            isInYViewPort: function(e, t) {
                var a = t.scrollTop,
                    n = t.height + t.scrollTop;
                return e.top < n + 100 && e.bottom > a - 100
            },
            getVisibleHeader: function(t, a) { var n = "";
                this._rendered_header_cache = []; for (var i in t._h_cols) { var r = t._h_cols[i]; if (this.isInXViewPort({ left: r.left, right: r.left + e._cols[i] }, a)) { n += r.div.outerHTML, this._rendered_header_cache.push(r.div.getAttribute("data-col-id")) } } return n },
            updateHeader: function(t, a, n) {
                ...
                if (this.getVisibleHeader(t, a)) { for (var d = this._rendered_header_cache.slice(), s = [], _ = 0, l = o.length; _ < l; _++) { var c = d.indexOf(o[_]);
            ...
            _deleteHeaderCells: function(e, t, a) { for (var n = 0; n < e.length; n++) { var i = a.querySelector('[data-col-id="' + e[n] + '"]');
                    i && a.removeChild(i) } },
            _addHeaderCells: function(e, t, a) { for (var n = "", i = 0; i < e.length; i++) n += t._h_cols[e[i]].div.outerHTML;
            ...
            updateLabels: function(e, t, a) {
                ...
                if (n.length || (this.getVisibleLabels(e, t), n = this._rendered_labels_cache.slice()), this.getVisibleLabels(e, t)) {
                    for (var i = this._rendered_labels_cache.slice(), r = [], o = 0, _ = n.length; o < _; o++) { var d = i.indexOf(n[o]);
            ...
            _deleteLabelCells: function(e, t, a) { for (var n = 0; n < e.length; n++) { var i = a.querySelector('[data-row-index="' + e[n] + '"]');
                    i && a.removeChild(i) } },
            _addLabelCells: function(e, t, a) { for (var n = "", i = 0; i < e.length; i++) n += t._label_rows[e[i]].div;
                a.insertAdjacentHTML("beforeEnd", n) },
            clearPreparedEventsCache: function() { this.cachePreparedEvents(null) },
            cachePreparedEvents: function(e) { this._prepared_events_cache = e, this._prepared_events_coordinate_cache = e },
            getPreparedEvents: function(t) { var a; return this._prepared_events_cache ? a = this._prepared_events_cache : (a = e._prepare_timeline_events(t), a.$coordinates = {}, this.cachePreparedEvents(a)), a },
            updateEvents: function(t, a) {
                ...
                if (r) {
                    for (var o = 0; o < this._rendered_labels_cache.length; o++) { var _ = this._rendered_labels_cache[o],
                            d = [],
                            s = i[_] ? i[_].slice() : [];
                        e._timeline_calculate_event_positions.call(t, n[_]); for (var l = e._timeline_smart_render.getVisibleEventsForRow(t, a, n, _), c = 0, h = l.length; c < h; c++) { var u = s.indexOf(l[c].id);
                            u > -1 ? s.splice(u, 1) : d.push(l[c]) } var g = r.querySelector('[data-section-index="' + _ + '"]');
                        s.length && this._deleteEvents(s, t, g), d.length && this._addEvents(d, t, g, _) }
                    e._populate_timeline_rendered(e.$container), t._matrix = n
                }
            },
            _deleteEvents: function(e, t, a) { for (var n = 0; n < e.length; n++) { var i = a.querySelector('[event_id="' + e[n] + '"]');
                    i && (i.classList.contains("dhx_in_move") || a.removeChild(i)) } },
            _addEvents: function(t, a, n, i) { var r = e._timeline_update_events_html.call(a, t);
                    ...
                    if (o)
                        for (var _ = 0, d = o.length; _ < d; _++) {
                            ...
                            n.$coordinates && n.$coordinates[h] ? (s = n.$coordinates[h].xStart,
                                l = n.$coordinates[h].xEnd) : (s = e._timeline_getX(c, !1, t), l = e._timeline_getX(c, !0, t), n.$coordinates && (n.$coordinates[h] = { xStart: s, xEnd: l })), e._timeline_smart_render.isInXViewPort({ left: s, right: l }, a) && (r.push(c), this._rendered_events_cache[i] || (this._rendered_events_cache[i] = []), this._rendered_events_cache[i].push(c.id))
                        }
                }
                return r
            },
            ...
            updateGridRows: function(e, t) { this._rows_to_delete.length && this._deleteGridRows(this._rows_to_delete), this._rows_to_add.length && this._addGridRows(this._rows_to_add, e, t) },
            _deleteGridRows: function(t) { var a = e.$container.querySelector(".dhx_cal_data .dhx_timeline_data_col"); if (a) { for (var n = 0; n < t.length; n++) { var i = a.querySelector('[data-section-index="' + t[n] + '"]');
                        a.removeChild(i) }
            ...
            _addGridCols: function(t, a, n) {
                ...
                if (i) {
                    for (var r = this.getPreparedEvents(a), o = 0; o < this._rendered_labels_cache.length; o++) {
                        ...
                        var l;
                        if (l = "cell" == a.render ? i.querySelector('[data-section-index="' + _ + '"]') : i.querySelector('[data-section-index="' + _ + '"] .dhx_timeline_data_row')) { for (var c = 0; c < t.length; c++) { if (!l.querySelector('[data-col-id="' + t[c] + '"]')) { var h = this.getVisibleGridCell(a, n, s, r, _, t[c]);
                                    h && (d += h) } }
