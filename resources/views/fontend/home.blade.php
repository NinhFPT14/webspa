                     ...
                     <div class="row">
                         <div class="col-12">
                             <div class="slider_content slider_c_three">
                                 <h1>Nơi Vẻ Đẹp Tỏa Sáng</h1>
                                 <p>Hãy đến với chúng tôi để bạn luôn là người đẹp nhất.</p>
                     ...
                     <div class="row">
                         <div class="col-12">
                             <div class="slider_content slider_c_three color_three">
                                 <h1>Hàng ngàn sản phẩm chất lượng</h1>
                                 <p>Queen Beauty mua sắm đồ làm đẹp không khó</p>
                                 <a href="{{route('product')}}">Mua Ngay</a>
                             </div>
                         </div>
                     </div>
                 </div>
                    ...
                    <div class="col-lg-12">
                        <div class="single_blog">
                            <div class="blog_thumb">
                                <a href="{{route('detailBlog')}}"><img src="fontEnd/img/blog/blog7.jpg" alt=""></a>
                            ...
                            <div class="blog_content">
                                <h4><a href="{{route('detailBlog')}}">GIẢM GIÁ 50 % TẤT CẢ DỊCH VỤ LÀM ĐẸP TẠI THANH HÒA SPA -
                                        NHÂN DỊP 8/3</a></h4>
