            ...
            <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-12 ">
                        <div class="single_product">
                            <div class="product_thumb">
                                <a class="primary_img"
                                    href="{{route('detailService',['slug'=>$value->slug,'id'=>$value->id])}}"><img
                                ...
                                <div class="action_links">
                                    <ul>
                                        <li class="quick_view"><a
                                                href="{{route('detailService',['slug'=>$value->slug,'id'=>$value->id])}}"
                            ...
                            <div class="product_content grid_content">
                                <div class="product_name">
                                    <h4><a
                                            href="{{route('detailService',['slug'=>$value->slug,'id'=>$value->id])}}">{{$value->name}}</a>
                                    </h4>
                                </div>
                ...
                <div class="shop_toolbar t_bottom">
                    <div class="pagination">
                        <ul>
                            <li class="current">{!!$service->links()!!}</li>
                        </ul>
                    </div>
                </div>
                <!--shop toolbar end-->
